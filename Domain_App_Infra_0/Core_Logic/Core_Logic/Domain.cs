...
namespace SCADA.Domain
{
    // Formula class to create formula objects:
     public class Formula
     {
      // Formula Table parameters
        ...
        private float Water_Cement_Ratio;
      ...
      // Create Formula:
       ...
       public Formula(string formula_Code, string concrete_Grade, float Cement_Portion, float Sand_Portion, float Gravel_Portion, float Water_Cement_Ratio, float ADX1_Portion, float ADX2_Portion,  float Ice_Portion, float Color_Portion)
       {
      ...
      // Set Formula Parameters:
        ...
        public void setWaterCementRatio(float water_cement_ratio)
        {
            this.Water_Cement_Ratio = water_cement_ratio;
        }
    ...
    {
        // Componenets data fields:  // silo, bin, conveyor 
        private int ID; // Auto_Incremented
        private string Name;
        private float Cost;
        private string Type;
    ...
    //----------------------------------------------------
    // Material Data Class:
    public class MaterialsData // components in GUI
    {
        // data fields:
        public string Code; //change from int "material_id" to string "Code" // Auto_Incremented 1: Sand, 2: Gravel, 3: Cement, 4: Water, 5: ADX1, 6: ADX2, 7: Color, 8: Ice 
        public string Description;   // add description field
        public string UOM;          // Mondefied from Unite to UOM  unit of measurement field
        public float Gravity;       // add specific gravity field
        public string Color;       //  add color field
        public string Type;       // add type field
                                  //private string Material_Name;
                                  //private float Cost_Per_Unit;
        public decimal Absorption;
        public decimal MaxDiameter;
        public string Class;
        public decimal WaterContent;
        public int Ice;
        public decimal PercentOnCement;
        public decimal InfluenceWC;
        ...
        public MaterialsData(string Code,string Description,string UOM, float Gravity, string Color ,string Type, decimal absorption = 0,
            decimal maxDiameter = 0,
            string @class = "",
            decimal waterContent = 0,
            int ice = 0,
            decimal percentOnCement = 0,
            decimal influenceWC = 0,
            string altCode = "")
        {
            ...
            this.Ice = ice;
            this.PercentOnCement = percentOnCement;
            this.InfluenceWC = influenceWC;
            AltCode = altCode;
        ...
        public void setAbsorption(decimal Absorption)
        {
            this.Absorption = Absorption;
        }   
        public void setMaxDiameter(decimal MaxDiameter)
        {
            this.MaxDiameter = MaxDiameter;
        }
        ...
        public void setWaterContent(decimal WaterContent)
        {
            this.WaterContent = WaterContent;
        }
        ...
        public void setPercentOnCement(decimal PercentOnCement)
        {
            this.PercentOnCement = PercentOnCement;
        }
        public void setInfluenceWC(decimal InfluenceWC)
        {
            this.InfluenceWC = InfluenceWC;
        }
        ...
        public decimal getAbsorption()
        {
            return Absorption;
        }
        public decimal getMaxDiameter()
        {
            return MaxDiameter;
        }
        ...
        public decimal getWaterContent()
        {
            return WaterContent;
        }
        public int getIce()
        ...
        public decimal getPercentOnCement()
        {
            return PercentOnCement;
        }
        public decimal getInfluenceWC()
        {
            return InfluenceWC;
        }
